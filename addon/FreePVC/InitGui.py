...
print("=" * 60)
print("FreePVC InitGui.py executing...")
print("=" * 60)
...
try:
    ...
    class FreePVCWorkbench(FreeCADGui.Workbench):
        ...
        def Initialize(self):
            ...
            # Import command modules - use direct import instead of relative
            try:
                import sys
                import os
                ...
                if addon_dir:
                    commands_dir = os.path.join(addon_dir, "commands")
    ...
    print("=" * 60)
    print(f"✗ ERROR in FreePVC InitGui.py: {e}")
    import traceback
    traceback.print_exc()
    print("=" * 60)
